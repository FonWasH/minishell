...
debug:			cdebug
				...
				@valgrind $(VOPTIONS) --suppressions=".valgrindignore" ./$(NAME)

debug_log:		cdebug
				@echo "🚧 Running $(NAME) in debug log mode.."
				@valgrind $(VOPTIONS) --gen-suppressions=all --log-file=valgrind.log ./$(NAME)
...
title:
				@clear
				@echo ""
				@echo "$(B)███$(G)╗   $(B)███$(G)╗$(B)██$(G)╗$(B)███$(G)╗   $(B)██$(G)╗$(B)██$(G)╗$(B)███████$(G)╗$(B)██$(G)╗  $(B)██$(G)╗$(B)███████$(G)╗$(B)██$(G)╗     $(B)██$(G)╗"
				@echo "$(B)████$(G)╗ $(B)████$(G)║$(B)██$(G)║$(B)████$(G)╗  $(B)██$(G)║$(B)██$(G)║$(B)██$(G)╔════╝$(B)██$(G)║  $(B)██$(G)║$(B)██$(G)╔════╝$(B)██$(G)║     $(B)██$(G)║"
				@echo "$(B)██$(G)╔$(B)████$(G)╔$(B)██$(G)║$(B)██$(G)║$(B)██$(G)╔$(B)██$(G)╗ $(B)██$(G)║$(B)██$(G)║$(B)███████$(G)╗$(B)███████$(G)║$(B)█████$(G)╗  $(B)██$(G)║     $(B)██$(G)║"
				@echo "$(B)██$(G)║╚$(B)██$(G)╔╝$(B)██$(G)║$(B)██$(G)║$(B)██$(G)║╚$(B)██$(G)╗$(B)██$(G)║$(B)██$(G)║╚════$(B)██$(G)║$(B)██$(G)╔══$(B)██$(G)║$(B)██$(G)╔══╝  $(B)██$(G)║     $(B)██$(G)║"
				@echo "$(B)██$(G)║ ╚═╝ $(B)██$(G)║$(B)██$(G)║$(B)██$(G)║ ╚$(B)████$(G)║$(B)██$(G)║$(B)███████$(G)║$(B)██$(G)║  $(B)██$(G)║$(B)███████$(G)╗$(B)███████$(G)╗$(B)███████$(G)╗"
				@echo "$(G)╚═╝     ╚═╝╚═╝╚═╝  ╚═══╝╚═╝╚══════╝╚═╝  ╚═╝╚══════╝╚══════╝╚══════╝$(NC)"
				@echo "$(G)$(IT)Author: $(C)FonWasH $(G)($(C)juperez$(G))$(NC)"
				@echo ""

-include 		$(OBJS:.o=.d)
.PHONY: 		all clean fclean re run cdebug debug debug_log forbidden norminette title
